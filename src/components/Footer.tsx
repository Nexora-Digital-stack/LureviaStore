      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-indigo-400 mb-4">Lurevia Store</h3>
            <p className="text-gray-300 mb-4">
              Your premier destination for quality products. We offer a curated selection of 
              fashion, electronics, and accessories to enhance your lifestyle.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Lurevia Store. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
